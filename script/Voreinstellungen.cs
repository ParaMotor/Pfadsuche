...
//Variablen
    ...
    //"Inventar"
    public Transform SpawnRotationSchreibtisch;
    public Transform SpawnRotationChair;
    public Transform SpawnRotationSofa;
    public GameObject BuecherregalObjekt;
    public GameObject SchreibtischObjekt;
    public GameObject SofaObjekt;
    public GameObject ChairObjekt;
...
//Methoden für das UI
    ...
    * die Farbe des Feldes wird auf die "StartFarbe" gesetzt*/
    ...
    {
        Instantiate(BuecherregalObjekt, Vector3.up, SpawnRotationSofa.rotation);
    }
    public void SpawnSchreibtisch()
    {
        Instantiate(SchreibtischObjekt, Vector3.up, SpawnRotationSchreibtisch.rotation);
    }
    public void SpawnSofa()
    {
        Instantiate(SofaObjekt, Vector3.up, SpawnRotationSofa.rotation);
    }
    public void SpawnChair()
    {
        Instantiate(ChairObjekt, Vector3.up, SpawnRotationChair.rotation);
    }
